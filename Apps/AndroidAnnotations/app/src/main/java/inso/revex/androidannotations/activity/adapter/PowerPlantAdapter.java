package inso.revex.androidannotations.activity.adapter;
...
import inso.revex.androidannotations.activity.ActivityAllPowerPlants;
import inso.revex.androidannotations.activity.ActivityAllPowerPlants_;
import inso.revex.androidannotations.activity.ActivityPowerPlantOverview;
import inso.revex.androidannotations.activity.ActivityPowerPlantOverview_;
import inso.revex.androidannotations.activity.R;
...
public class PowerPlantAdapter extends RecyclerView.Adapter<PowerPlantAdapter.PowerPlantViewHolder> implements  OnItemClickListener{
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent i = new Intent(context, ActivityPowerPlantOverview_.class);
