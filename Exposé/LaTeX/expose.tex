...
\begin{figure}[!htbp]
	\centering	
	\subfigure[Diagramm: Github Stars]{\includegraphics[width=0.49\textwidth]{imgs/github_stars.png}}
	\subfigure[Diagramm: Github Commits]{\includegraphics[width=0.49\textwidth]{imgs/github_commits.png}}
\end{figure}
