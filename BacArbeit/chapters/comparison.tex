...
\begin{table}[h]
	...
	\begin{tabular}{m{3.2cm}|m{4.8cm}|m{4.8cm}|m{4.8cm}|m{4.8cm}}
	  \centering
	  \label{tableVergleich}	 
	   & \textbf{Retrofit} & \textbf{Jersey} & \textbf{Spring for Android}  & \textbf{AndroidAnnotations}  \\  \hline \hline
	   \multicolumn{5}{c}{\textbf{Allgemein}} \\ \hline \hline
	  \textbf{Lizenz} &
	  Apache License Version 2.0 & CDDL Version 1.1 \newline GPL Version 2 & 
	  Apache License Version 2.0 & 
	  Apache License 2.0 \newline CDDL \\ \hline
	  \textbf{aktive Community} & Ja & Ja & Ja & Ja\\ \hline
	  \textbf{Dokumentation} & Grundlegen Verwendungsweise auf der Homepage erklärt & aktuelle und umfangreiche Dokumentation vorhanden & aktuelle und umfangreiche Dokumentation vorhanden  & aktuelle und umfangreiche Dokumentation vorhanden\\ \hline 
	  \textbf{Codebeispiele vorhanden} &  Ja  & Ja, aber nur für die clientseite Implementierung - nicht spezielle für die Androidentwicklung & Ja & Ja\\ \hline \hline
	  \multicolumn{5}{c}{\textbf{Performance}} \\ \hline \hline
